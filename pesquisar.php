...
if(isset($_GET['pesquisar']) && $_GET['pesquisar'] !== '') {
    ...
    $condicoes[] = "(usuario = '$valor_pesquisar' OR nome = '$valor_pesquisar' OR permissao = '$valor_pesquisar' OR statususer = '$valor_pesquisar')";
}
...
if(isset($_GET['permissao']) && $_GET['permissao'] !== '') {
            ...
            <div>
                <div class="d-flex justify-content-end align-items-end">
                    ...
                    <form action="pesquisar.php" method="GET" class="form-inline">
                        ...
                        <button type="submit" class="btn btn-primary"><img src="#" alt="#"></button>
                    </form>
                </div>
                <br>
